...
class ParticipantsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        data = ParticipantsData.participantsData
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let participantsCell = cell as? ParticipantsTableViewCell {
            if let therealdata = data {
                let participants = therealdata[indexPath.row]
                
                participantsCell.positionLabel?.text = participants.position
                participantsCell.nameLabel?.text = participants.name
